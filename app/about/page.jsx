...
const experience = {
  title: "About Me",
  description:
    "Hello! I’m Tafiyatul Jannat. As a MERN stack developer, I specialize in MongoDB for efficient data management, Express.js for building robust APIs, React for dynamic and interactive user interfaces, and Node.js for seamless integration between frontend and backend components. ",
  items: [
    {
...
const education = {
  title: "My Education",
  description:
    "I am a Computer Science and Engineering graduate with a strong passion Web Development. HTML, CSS, Tailwind CSS, JavaScript,Typescript, React JS,Next JS, Redux,Node Js,Express Js.  I have built several projects.",
  items: [
    {
                ...
                <ul className=" grid grid-cols-1  gap-y-6 max-w-[620px] mx-auto xl:mx-0">
                  {about.info.map((item, index) => {
                    return (
                      <li
                        key={index}
                        className=" flex items-center justify-center xl:justify-start gap-0 md:gap-4"
                      >
